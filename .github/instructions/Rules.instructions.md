...
Front-end: React + Tailwind inside a Tauri (Rust) shell.
Automation: Python + Playwright.
Data: PostgreSQL 16 with pgvector and OpenAI embeddings.
Key conventions: zustand for state, shadcn/ui components, migrations via sqlx, Conventional-Commit messages, and no secrets in source control.
